...
**หมายเหตุทางเทคนิค**: `fetch('file://...')` เรียกตรงๆ จาก background service worker ของ Manifest V3
ไม่ได้เลย (ข้อจำกัดของ Chromium เอง ไม่เกี่ยวกับ permission) เลยต้องใช้วิธีเปิดไฟล์ในแท็บพื้นหลัง
(ไม่ focus) สั้นๆ แล้วดึงเนื้อหาออกมาแทน — อาจเห็นแท็บใหม่กระพริบแวบเดียวตอนซิงค์ แล้วมันจะปิดตัวเองทันที
ถือเป็นเรื่องปกติ
